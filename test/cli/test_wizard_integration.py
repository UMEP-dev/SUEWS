...
from src.supy.cli.wizard.validators.yaml_processor_integration import YAMLProcessorValidator
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            engine.session.configuration = {
                ...
                'initial_conditions': {
                    ...
                    'surface_temperature': {'paved': 15.0, 'bldgs': 15.0, 'grass': 14.5},
