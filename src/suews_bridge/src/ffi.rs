...
unsafe extern "C" {
    ...
    #[cfg(feature = "physics")]
    pub fn suews_scm_multitsteps_c(
        timer_flat: *const c_double,
        timer_len: c_int,
        config_flat: *const c_double,
        config_len: c_int,
        ...
        nlayer: c_int,
        ndepth: c_int,
        scm_params_flat: *const c_double,
        scm_params_len: c_int,
        bg_nt: c_int,
        bg_nz: c_int,
        bg_t_sec: *const c_double,
        bg_z: *const c_double,
        bg_theta_flat: *const c_double,
        bg_q_flat: *const c_double,
        snap_every: c_int,
        n_snap: c_int,
        nz_snap: c_int,
        timer_out: *mut c_double,
        ...
        output_flat: *mut c_double,
        output_len: c_int,
        scm_out_flat: *mut c_double,
        scm_out_len: c_int,
        snap_z_out: *mut c_double,
        snap_theta_out: *mut c_double,
        snap_q_out: *mut c_double,
        snap_buf_len: c_int,
        sim_err_code: *mut c_int,
        sim_err_message: *mut c_char,
        sim_err_message_len: c_int,
