...
SUBROUTINE suewsstebbscouple(self, flginit, datetimeLine, &
   ...
   USE module_phys_stebbs_precision
   USE module_phys_stebbs_core, ONLY: LBM, resolution
   USE module_phys_stebbs_func, ONLY: ext_conv_coeff
