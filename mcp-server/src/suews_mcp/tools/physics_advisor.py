...
def check_method_compatibility(method1: str, value1: str, method2: str, value2: str) -> Tuple[bool, str]:
...
async def check_physics_compatibility(methods: Dict[str, str]) -> str:
    ...
    for warning in INCOMPATIBILITY_WARNINGS:
        ...
        if len(condition) == 4:
            ...
            if (method1 in methods and methods[method1] == value1 and 
                method2 in methods and methods[method2] == value2_check):
    ...
    if methods.get("NetRadiationMethod") == "3" and methods.get("StorageHeatMethod") == "1":
        response += "- ✅ Good combination: LDOWN_AIR + OHM is a robust choice for most urban studies\n"
