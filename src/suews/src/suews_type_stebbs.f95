module module_type_stebbs
    ...
    TYPE, PUBLIC :: BUILDING_ARCHETYPE_PRM
      ...
      REAL(KIND(1D0)) :: InternalMassArea = 0.0D0 ! Surface area of internal mass used for indoor heat exchange [m2]
      ...
      REAL(KIND(1D0)) :: WallOuterCapFrac = 0.0D0 ! Weighting factor for heat capacity of walls [-]
      ...
      REAL(KIND(1D0)) :: RoofOuterCapFrac = 0.0D0 ! Weighting factor for heat capacity of roof [-]
