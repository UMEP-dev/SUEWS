...
class ModelDocExtractor:
    ...
    def _extract_model(self, model_class: Type[BaseModel], include_internal: bool) -> Dict[str, Any]:
    ...
    def _extract_field(self, field_name: str, field_info: FieldInfo, 
                      model_name: str, include_internal: bool) -> Dict[str, Any]:
    ...
    def _extract_type_info(self, type_hint: Any) -> Dict[str, Any]:
        ...
        type_info = {
            "origin": origin.__name__ if origin and hasattr(origin, "__name__") else None,
    ...
    def _extract_default(self, field_info: FieldInfo) -> Optional[Dict[str, Any]]:
        ...
        if field_info.default is not None and field_info.default != inspect.Parameter.empty:
            ...
            try:
                ...
                return {"default_type": "default_factory", "default": "Dynamically generated"}
        return None
    ...
    def _serialize_value(self, value: Any, default_type: str) -> Dict[str, Any]:
        ...
        if isinstance(value, BaseModel):
            ...
            result["default"] = f"List of {len(value)} {value[0].__class__.__name__} objects"
            result["is_complex"] = True
    ...
    def _extract_constraints(self, field_info: FieldInfo, field_type: Any) -> Optional[Dict[str, Any]]:
    ...
    def _extract_enum_options(self, description: str, enum_class: Type[Enum], 
                             include_internal: bool) -> List[Dict[str, Any]]:
    ...
    def _get_enum_class(self, field_info: FieldInfo, field_type: Any) -> Optional[Type[Enum]]:
        ...
        if origin and hasattr(origin, "__name__") and origin.__name__ in {"RefValue", "FlexibleRefValue"}:
    ...
    def _is_required_field(self, field_info: FieldInfo) -> bool:
        ...
        if field_info.default is not None and field_info.default != inspect.Parameter.empty:
            ...
            return "PydanticUndefined" in default_str or "undefined" in default_str.lower()
    ...
    def _is_site_specific(self, field_name: str, model_name: str) -> bool:
        ...
        site_patterns = [
            ...
            "area", "height", "width", "depth", "z", "z_meas",
            "tstep", "forcing_file", "output_file", "start_time", "end_time",
            "population", "traffic", "popdens",
            "albedo", "emissivity", "z0m_in", "zdm_in",
            "temp_c", "temp_s", "tsurf", "tair",
            "state_", "initial", "soilstore", "soil_moisture",
            "fraction", "frac", "lai", "veg_frac", "bldg_frac",
        ...
        model_contexts = [
            "initialstate", "properties", "landcover", 
            "modelcontrol", "site", "spartacus"
        ]
        
        field_lower = field_name.lower()
        model_lower = model_name.lower()
        
        return any(p in field_lower for p in site_patterns) or \
               any(c in model_lower for c in model_contexts)
