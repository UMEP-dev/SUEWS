...
class BasicConfigStep(WizardStep):
    ...
    def __init__(self, session):
        ...
        self.description = "Let's start with basic information about your site and simulation."
    ...
    def collect_input(self) -> Dict[str, Any]:
        ...
        data["site.name"] = Prompt.ask(
            "Site name",
            default=default_name or "MySite"
        )
        ...
        data["site.altitude"] = FloatPrompt.ask(
            "Altitude [m]",
            default=default_alt
        )
        ...
        if timezone_input:
            ...
            try:
                ...
                if detected_tz:
                    console.print(f"[green]Auto-detected timezone: {detected_tz}[/green]")
                    data["site.timezone"] = detected_tz
                else:
                    data["site.timezone"] = "UTC"
                    console.print("[yellow]Could not detect timezone, using UTC[/yellow]")
            except Exception:
                data["site.timezone"] = "UTC"
        ...
        start_date_str = Prompt.ask(
            ...
            default=default_start or "2023-01-01"
        )
        ...
        end_date_str = Prompt.ask(
            "End date (YYYY-MM-DD)",
            default=default_end or "2023-12-31"
        )
    ...
    def validate(self, data: Dict[str, Any]) -> bool:
        ...
        if timestep <= 0:
            ...
            console.print("[yellow]Warning: Very small timestep may impact performance[/yellow]")
        elif timestep > 3600:
            console.print("[yellow]Warning: Large timestep may miss important variations[/yellow]")
