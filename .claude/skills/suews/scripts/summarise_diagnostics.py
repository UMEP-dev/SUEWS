#!/usr/bin/env python3
"""Read a SUEWS run's diagnostics.json and print a 5-line plain-English
summary. Pure stdlib so the Skill never pulls supy as a dependency.
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        print("Usage: summarise_diagnostics.py <run_dir>", file=sys.stderr)
        sys.exit(2)
