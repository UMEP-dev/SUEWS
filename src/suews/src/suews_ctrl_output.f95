...
! Define aggregation methods here
   ...
   DATA(varListAll(n), &
        n=1, 5)/ &
      varAttr('Year', 'YYYY', fy, 'Year', 'T', 'datetime', 0), &
      varAttr('DOY', 'DOY', fy, 'Day of Year', 'T', 'datetime', 0), &
      varAttr('Hour', 'HH', fy, 'Hour', 'T', 'datetime', 0), &
      varAttr('Min', 'MM', fy, 'Minute', 'T', 'datetime', 0), &
      varAttr('Dectime', '-', fd, 'Decimal time', 'T', 'datetime', 0) &
      /
