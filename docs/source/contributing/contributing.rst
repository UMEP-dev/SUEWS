...
- **Feature Requests**: Discuss ideas in the `SUEWS Discussion Forum <https://suews.discourse.group/>`_

.. note:: If you are interested in contributing to the project, please start a discussion in the `SUEWS Discussion Forum <https://suews.discourse.group/>`_ to share your ideas.
...
- **Discussions**: `SUEWS Discussion Forum <https://suews.discourse.group/>`_
