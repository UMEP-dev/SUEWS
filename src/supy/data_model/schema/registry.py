...
class SchemaRegistry:
    ...
    def register_version(self, version: str, schema_path: str, description: Optional[str] = None):
        """
    ...
    def generate_index_html(self, base_url: str, is_preview: bool = False, pr_number: Optional[int] = None) -> str:
        """
