...
SS_PREV_VARS = make_debug_surface_vars(
    "ss",
    "mm",
    "Soil moisture store (previous timestep) for {}",
    AggregationMethod.AVERAGE,
    "f104",
)
# Rename to add _prev suffix
...
SS_NEXT_VARS = make_debug_surface_vars(
    "ss",
    "mm",
    "Soil moisture store (next timestep) for {}",
    AggregationMethod.AVERAGE,
    "f104",
)
# Rename to add _next suffix
...
RESISTANCE_VARS = [
    ...
    OutputVariable(
        name="RA_h",
        unit="s m-1",
        description="Aerodynamic resistance for heat",
        aggregation=AggregationMethod.AVERAGE,
        group=OutputGroup.DEBUG,
        level=OutputLevel.DEFAULT,
        format="f104",
    ...
    OutputVariable(
        name="RB",
        unit="s m-1",
        description="Boundary layer resistance",
        aggregation=AggregationMethod.AVERAGE,
        group=OutputGroup.DEBUG,
        level=OutputLevel.DEFAULT,
        format="f104",
    ...
    OutputVariable(
        name="RAsnow",
        unit="s m-1",
        description="Aerodynamic resistance for snow",
        aggregation=AggregationMethod.AVERAGE,
        group=OutputGroup.DEBUG,
        level=OutputLevel.DEFAULT,
        format="f104",
...
RSS_VARS = make_debug_surface_vars(
    "rss", "s m-1", "Surface resistance for {}", AggregationMethod.AVERAGE, "f104"
)
...
VSMD_VARS = make_debug_surface_vars(
    "vsmd",
    "m3 m-3",
    "Volumetric soil moisture deficit for {}",
    AggregationMethod.AVERAGE,
    "f104",
)
...
COND_S1S2_VARS = make_debug_surface_vars(
    "cond_s1s2",
    "-",
    "Conductance parameter S1/G_sm + S2 for {}",
    AggregationMethod.AVERAGE,
    "f104",
)
...
COND_GSM_VARS = make_debug_surface_vars(
    "cond_gsm",
    "-",
    "Conductance parameter G_sm for {}",
    AggregationMethod.AVERAGE,
    "f104",
)
...
COND_CALC_VARS = make_debug_surface_vars(
    "cond_calc",
    "-",
    "Conductance calculation term for {}",
    AggregationMethod.AVERAGE,
    "f104",
)
...
G_KDOWN_VARS = make_debug_surface_vars(
    "g_kdown",
    "-",
    "Kdown modifier for stomatal conductance for {}",
    AggregationMethod.AVERAGE,
    "f104",
)
...
G_DQ_VARS = make_debug_surface_vars(
    "g_dq",
    "-",
    "Specific humidity deficit modifier for stomatal conductance for {}",
    AggregationMethod.AVERAGE,
    "f104",
)
...
G_TA_VARS = make_debug_surface_vars(
    "g_ta",
    "-",
    "Air temperature modifier for stomatal conductance for {}",
    AggregationMethod.AVERAGE,
    "f104",
)
...
G_SMD_VARS = make_debug_surface_vars(
    "g_smd",
    "-",
    "Soil moisture deficit modifier for stomatal conductance for {}",
    AggregationMethod.AVERAGE,
    "f104",
)
...
G_LAI_VARS = make_debug_surface_vars(
    "g_lai",
    "-",
    "LAI modifier for stomatal conductance for {}",
    AggregationMethod.AVERAGE,
    "f104",
)
...
ATMOS_VARS = [
    ...
    OutputVariable(
        name="avcp",
        unit="J kg-1 K-1",
        description="Air specific heat capacity",
        aggregation=AggregationMethod.AVERAGE,
        group=OutputGroup.DEBUG,
        level=OutputLevel.DEFAULT,
        format="f104",
...
MISC_VARS = [
    OutputVariable(
        name="i_iter",
        unit="-",
        description="Number of iterations in convergence loop",
        aggregation=AggregationMethod.AVERAGE,
        group=OutputGroup.DEBUG,
        level=OutputLevel.DEFAULT,
        format="f104",
    ...
    OutputVariable(
        name="FAIBldg_use",
        unit="-",
        description="Building frontal area index used",
        aggregation=AggregationMethod.AVERAGE,
        group=OutputGroup.DEBUG,
        level=OutputLevel.DEFAULT,
        format="f104",
    ...
    OutputVariable(
        name="FAIEveTree_use",
        unit="-",
        description="Evergreen tree frontal area index used",
        aggregation=AggregationMethod.AVERAGE,
        group=OutputGroup.DEBUG,
        level=OutputLevel.DEFAULT,
        format="f104",
    ...
    OutputVariable(
        name="FAIDecTree_use",
        unit="-",
        description="Deciduous tree frontal area index used",
        aggregation=AggregationMethod.AVERAGE,
        group=OutputGroup.DEBUG,
        level=OutputLevel.DEFAULT,
        format="f104",
    ...
    OutputVariable(
        name="FAI",
        unit="-",
        description="Total frontal area index",
        aggregation=AggregationMethod.AVERAGE,
        group=OutputGroup.DEBUG,
        level=OutputLevel.DEFAULT,
        format="f104",
    ...
    OutputVariable(
        name="dqndt",
        unit="W m-2",
        description="Rate of change of net radiation",
        aggregation=AggregationMethod.AVERAGE,
        group=OutputGroup.DEBUG,
        level=OutputLevel.DEFAULT,
        format="f104",
