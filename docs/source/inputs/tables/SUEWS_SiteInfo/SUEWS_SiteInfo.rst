...
The above text files (used to be stored as worksheets in **SUEWS_SiteInfo.xlsm** for versions prior to v2018a) can be edited directly. Please note this file is subject to possible changes from version to version due to new features, modifications, etc.
