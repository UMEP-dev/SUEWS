...
from supy.data_model.validation.pipeline.phase_a_parameter_update import annotate_missing_parameters
from supy.data_model.validation.pipeline.phase_a_refactored import annotate_missing_parameters_refactored
...
class TestBackwardCompatibility:
    ...
    def compare_reports(self, original: str, refactored: str, show_diff: bool = True) -> bool:
