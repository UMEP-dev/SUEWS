...
def _migrate_2026_6_dev1_to_2026_6_dev2(cfg: dict) -> dict:
    """Stamp the experimental modelled-FAI validation policy.

    The 2026.6.dev2 delta changes public-mode validation and documentation for
    model.physics.frontal_area_index, but the YAML shape is unchanged.
    """
    return cfg


def _migrate_2026_5_to_2026_6_dev2(cfg: dict) -> dict:
    """Chain 2026.5 -> 2026.6.dev1 -> 2026.6.dev2."""
    cfg = _migrate_2026_5_to_2026_6_dev1(cfg)
    return _migrate_2026_6_dev1_to_2026_6_dev2(cfg)
...
_HANDLERS: dict[tuple[str, str], Handler] = {
    ...
    ("2026.5", CURRENT_SCHEMA_VERSION): _migrate_2026_5_to_2026_6_dev2,
