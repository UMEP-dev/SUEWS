...
def test_sample_config_has_version():
    ...
    assert 'config_version' in config, "sample_config.yml should have 'config_version' field"
...
def test_yaml_update():
    ...
    try:
        ...
        print(f"✓ YAML update successful: version={updated['version']}, config_version={updated['config_version']}")
    finally:
        yaml_path.unlink()
