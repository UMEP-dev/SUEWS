...
def get_contextual_suggestions(
    ...
    morphology_values = {
        "city_centre": {
            "height_mean": {"value": 25.0, "range": [15.0, 50.0], 
                           "rationale": "Typical for central business districts"},
            "height_stdev": {"value": 10.0, "range": [5.0, 20.0],
                            "rationale": "Moderate variability in building heights"},
            "frontal_area_index": {"value": 0.35, "range": [0.25, 0.45],
                                  "rationale": "Dense urban development"},
            "plan_area_fraction": {"value": 0.45, "range": [0.35, 0.55],
                                  "rationale": "High building coverage"}
        },
        "suburban": {
            "height_mean": {"value": 8.0, "range": [5.0, 12.0],
                           "rationale": "Low-rise residential buildings"},
            "height_stdev": {"value": 3.0, "range": [1.0, 5.0],
                            "rationale": "Relatively uniform building heights"},
            "frontal_area_index": {"value": 0.15, "range": [0.10, 0.25],
                                  "rationale": "Sparse building arrangement"},
            "plan_area_fraction": {"value": 0.25, "range": [0.15, 0.35],
                                  "rationale": "Lower building density"}
        },
        "industrial": {
            "height_mean": {"value": 12.0, "range": [8.0, 20.0],
                           "rationale": "Warehouses and industrial buildings"},
            "height_stdev": {"value": 5.0, "range": [2.0, 8.0],
                            "rationale": "Mixed building types"},
            "frontal_area_index": {"value": 0.20, "range": [0.15, 0.30],
                                  "rationale": "Large footprint buildings"},
            "plan_area_fraction": {"value": 0.35, "range": [0.25, 0.45],
