...
type :: atm_state_shadow
   ...
   real(c_double) :: av_cp = 0.0_c_double
   real(c_double) :: dens_dry = 0.0_c_double
   real(c_double) :: av_density = 0.0_c_double
   ...
   real(c_double) :: lv_s_j_kg = 0.0_c_double
   real(c_double) :: tlv = 0.0_c_double
   real(c_double) :: psyc_hpa = 0.0_c_double
   real(c_double) :: psyc_ice_h_pa = 0.0_c_double
   ...
   real(c_double) :: z_l = 0.0_c_double
   real(c_double) :: ra_h = 0.0_c_double
   real(c_double) :: rs = 0.0_c_double
   real(c_double) :: u_star = 0.0_c_double
   real(c_double) :: t_star = 0.0_c_double
...
subroutine atm_state_pack(state, flat, n_flat, err)
   ...
   flat(idx) = state%av_cp; idx = idx + 1
   flat(idx) = state%dens_dry; idx = idx + 1
   flat(idx) = state%av_density; idx = idx + 1
   ...
   flat(idx) = state%lv_s_j_kg; idx = idx + 1
   flat(idx) = state%tlv; idx = idx + 1
   flat(idx) = state%psyc_hpa; idx = idx + 1
   flat(idx) = state%psyc_ice_h_pa; idx = idx + 1
   ...
   flat(idx) = state%z_l; idx = idx + 1
   flat(idx) = state%ra_h; idx = idx + 1
   flat(idx) = state%rs; idx = idx + 1
   flat(idx) = state%u_star; idx = idx + 1
   flat(idx) = state%t_star; idx = idx + 1
...
subroutine atm_state_unpack(flat, n_flat, state, err)
   ...
   idx = 1_c_int
   state%f_cloud = flat(idx); idx = idx + 1_c_int
   state%av_cp = flat(idx); idx = idx + 1_c_int
   state%dens_dry = flat(idx); idx = idx + 1_c_int
   state%av_density = flat(idx); idx = idx + 1_c_int
   ...
   state%lv_s_j_kg = flat(idx); idx = idx + 1_c_int
   state%tlv = flat(idx); idx = idx + 1_c_int
   state%psyc_hpa = flat(idx); idx = idx + 1_c_int
   state%psyc_ice_h_pa = flat(idx); idx = idx + 1_c_int
   ...
   state%z_l = flat(idx); idx = idx + 1_c_int
   state%ra_h = flat(idx); idx = idx + 1_c_int
   state%rs = flat(idx); idx = idx + 1_c_int
   state%u_star = flat(idx); idx = idx + 1_c_int
   state%t_star = flat(idx); idx = idx + 1_c_int
