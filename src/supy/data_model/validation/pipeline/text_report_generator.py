...
class TextReportGenerator:
    ...
    def generate(self, json_data: Dict[str, Any], phase: str, mode: str = "public") -> str:
        """
    ...
    def _format_warning_item(self, warning: Dict[str, Any], is_action: bool) -> List[str]:
        ...
        if warning_type == "parameter_renamed":
            ...
            lines.append(f"- Optional parameter {field} missing, using default: {default}")
    ...
    def save_text_report(self, json_data: Dict[str, Any], filepath: Path, 
                        phase: str, mode: str = "public") -> None:
        """
