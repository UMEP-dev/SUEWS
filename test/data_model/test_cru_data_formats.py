...
class TestCRUDataFormats:
    ...
    def test_parquet_csv_data_equivalence(self):
        ...
        # Check columns
        assert set(df_parquet.columns) == set(df_csv.columns), "DataFrames have different columns"
    ...
    def test_data_file_sizes(self):
        ...
        assert parquet_size < 5, f"Parquet file too large for distribution: {parquet_size:.1f}MB"
