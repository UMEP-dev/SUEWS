...
@mcp.tool(
    description="Get detailed explanation of a SUEWS parameter with typical values and scientific context"
)
async def explain_suews_parameter(parameter_name: str, include_examples: bool = True) -> str:
    ...
    try:
        ...
        result = await asyncio.wait_for(
            explain_parameter(parameter_name, include_examples), timeout=TOOL_TIMEOUT
        )
