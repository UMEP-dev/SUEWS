...
class StebbsProperties(BaseModel):
    ...
    specific_heat_capacity_hot_water_tank_wall: Optional[FlexibleRefValue(float)] = Field(
        default=500.0,
    ...
    specific_heat_capacity_hot_water_vessel_wall: Optional[FlexibleRefValue(float)] = Field(
        default=500.0,
