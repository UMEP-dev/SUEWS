...
STEBBS_VARIABLE_DEFS = [
    ...
    (
        ...
        "W",
        "f104",
        "Net longwave from internal wall to other indoor surfaces",
        0,
    ),
    (
        "Qlw_net_introof",
        "W",
        "f104",
        "Net longwave from internal roof to other indoor surfaces",
        0,
    ),
    (
        "Qlw_net_intwindow",
    ...
    (
        "QHconv_indair_intwall",
        "W",
        "f104",
        "Convective heat from indoor air to internal wall",
        0,
    ),
    (
        "QHconv_indair_introof",
        "W",
        "f104",
        "Convective heat from indoor air to internal roof",
        0,
    ),
    (
        "QHconv_indair_intwindow",
        "W",
        "f104",
    ...
    (
        "QHconv_extwall_outair",
        "W",
        "f104",
        "Convective heat from external wall to outdoor air",
        0,
    ),
    (
        "QHconv_extroof_outair",
        "W",
        "f104",
        "Convective heat from external roof to outdoor air",
        0,
    ),
    (
        "QHconv_extwindow_outair",
        "W",
        "f104",
    ...
    (
        "Qsw_reflected_wall_SA",
        "W",
        "f104",
        "Shortwave reflected by wall (SPARTACUS)",
        0,
    ),
    (
        "Qsw_reflected_roof_SA",
        "W",
        "f104",
        "Shortwave reflected by roof (SPARTACUS)",
        0,
    ),
