...
! Define aggregation methods here
   ...
   DATA(varListAll(n), &
      ...
      varAttr('Qsw_abs_wall_SA m-2', 'W', f104, 'Shortwave absorbed by wall per surface area', aA, 'STEBBS', 0), &
      varAttr('Qsw_abs_roof_SA m-2', 'W', f104, 'Shortwave absorbed by roof per surface area', aA, 'STEBBS', 0), &
      varAttr('Qsw_up_wall_SA m-2', 'W', f104, 'Shortwave reflected by wall per surface area', aA, 'STEBBS', 0), &
      varAttr('Qsw_up_roof_SA m-2', 'W', f104, 'Shortwave reflected by roof per surface area', aA, 'STEBBS', 0), &
      varAttr('Qlw_net_wall_SA m-2', 'W', f104, 'Net longwave from external wall to outdoor air per surface area', aA, 'STEBBS', 0), &
      varAttr('Qlw_net_roof_SA m-2', 'W', f104, 'Net longwave from external roof to outdoor air per surface area', aA, 'STEBBS', 0), &
      varAttr('Qlw_up_wall_SA m-2', 'W', f104, 'outgoing longwave from external wall to outdoor air per surface area', aA, 'STEBBS', 0), &
      varAttr('Qlw_up_roof_SA m-2', 'W', f104, 'outgoing longwave from external roof to outdoor air per surface area', aA, 'STEBBS', 0), &
