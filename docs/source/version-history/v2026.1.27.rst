...
- **DTS Interface**: New Direct Type System interface for Pydantic-to-Fortran execution, enabling cleaner integration between Python configuration and Fortran physics core. (:pr:`1050`)

- **Build Speed Improvement**: Split ``make dev`` and ``make dev-dts`` targets for faster development builds when DTS components are unchanged. (:pr:`1108`)
