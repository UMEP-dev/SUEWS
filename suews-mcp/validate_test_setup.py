...
def validate_test_files():
    ...
    try:
        ...
        spec = importlib.util.spec_from_file_location("conftest", tests_path / "conftest.py")
        conftest = importlib.util.module_from_spec(spec)
        spec.loader.exec_module(conftest)
        print("✓ conftest.py loads correctly")
        
        # Load test_server module
        spec = importlib.util.spec_from_file_location("test_server", tests_path / "test_server.py")
