...
- **Suggested reviewers**: Derive reviewer suggestions from changed files,
  `dev-ref/SCIENTIFIC_REVIEWERS.md`, and `.github/CODEOWNERS`; include them in
  the draft summary without treating them as automatic blockers.
...
### Suggested Reviewers
- @reviewer (source: CODEOWNERS or scientific reviewer guide; reason: changed area)
```
