module module_type_surface
   ...
   ! AnOHM calendar-day buffer sizing (single definition; also USEd by the driver)
   ...
   TYPE, PUBLIC :: OHM_STATE
      ...
      ! AnOHM (StorageHeatMethod=3) two-calendar-day forcing buffers:
      ...
      REAL(KIND(1D0)), DIMENSION(nsurf) :: anohm_a1_surf = -999.0D0
      REAL(KIND(1D0)), DIMENSION(nsurf) :: anohm_a2_surf = -999.0D0
      REAL(KIND(1D0)), DIMENSION(nsurf) :: anohm_a3_surf = -999.0D0
