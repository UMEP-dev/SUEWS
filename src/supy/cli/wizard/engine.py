...
from .utils.display import create_step_header, format_validation_error, format_validation_success
...
class WizardEngine:
    ...
    def _load_existing_config(self):
        ...
        with open(self.existing_config, 'r') as f:
            ...
            console.print(f"[green]Loaded configuration: {self.existing_config}[/green]")
    ...
    def run(self):
        ...
        while self.session.current_step < len(self.steps):
            ...
            # Show step header
            console.print(create_step_header(
    ...
    def _save_configuration(self):
        ...
        try:
            ...
            console.print(format_validation_success(f"Configuration saved to: {self.output_path}"))
