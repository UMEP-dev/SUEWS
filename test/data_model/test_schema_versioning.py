...
class TestSampleConfig:
    ...
    def test_sample_config_has_schema_version(self):
        ...
        assert 'schema_version' in config, "sample_config.yml should have 'schema_version' field"
        assert config['schema_version'] == "1.0"
        
        # Should not have old version fields
        assert 'version' not in config, "sample_config.yml should not have 'version' field"
        assert 'config_version' not in config, "sample_config.yml should not have 'config_version' field"
