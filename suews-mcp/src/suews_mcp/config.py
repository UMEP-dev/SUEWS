...
class MCPServerConfig(BaseSettings):
    ...
    suews_timeout: int = Field(default=300, description="Timeout for SUEWS operations in seconds")
    max_concurrent_simulations: int = Field(default=5, description="Maximum concurrent simulations")
    temp_dir: Optional[str] = Field(default=None, description="Temporary directory for simulations")
    
    # Tool configuration
    enable_simulation_tool: bool = Field(default=True, description="Enable simulation tool")
    enable_validation_tool: bool = Field(default=True, description="Enable validation tool")
    ...
    max_simulation_time_hours: float = Field(default=24.0, description="Maximum simulation time in hours")
