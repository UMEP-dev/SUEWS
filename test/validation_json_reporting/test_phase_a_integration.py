...
class TestPhaseAIntegration:
    ...
    def test_phase_a_missing_critical_parameter(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            critical_error = next(
                (e for e in errors if e["type"] == "missing_required_parameter"),
                None
            )
    ...
    def test_phase_a_renamed_parameters(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            renamed_info = next(
                (i for i in info_items if i["type"] == "parameter_renamed"),
                None
            )
    ...
    def test_phase_a_json_text_consistency(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            assert json_content["summary"]["total_errors"] == 2  # missing critical + extra param
            assert "ACTION NEEDED" in text_content
