...
_PHYSICS_REQUIRED_FORCING = FORCING_REGISTRY.physics_requirements()

LAI_VEG_COLUMNS = tuple(
    f"lai_{suffix}"
...
WUH_SURF_COLUMNS = tuple(
    f"wuh_{suffix}"
    for suffix in FORCING_REGISTRY.per_landcover_suffixes["wuh"]
)
