...
pub type AnthroEmisPrmSchema = crate::codec::SimpleSchema;
...
crate::codec::impl_state_module_fns! {
    prefix = anthro_emis_prm,
    state_type = AnthroEmisPrm,
    schema_type = AnthroEmisPrmSchema,
    payload_type = AnthroEmisPrmValuesPayload,
    flat_len_const = ANTHRO_EMIS_PRM_FLAT_LEN,
    schema_version_const = ANTHRO_EMIS_PRM_SCHEMA_VERSION,
    ffi_len_fn = ffi::suews_anthro_emis_prm_len,
    ffi_schema_version_fn = ffi::suews_anthro_emis_prm_schema_version,
    ffi_default_fn = ffi::suews_anthro_emis_prm_default,
}
#[cfg(test)]
mod tests {
    use super::*;
