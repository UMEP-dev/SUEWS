"""Basic tests for CRU data loading and temperature initialization.

This test file focuses on the core functionality: ensuring CRU data loads properly
for initial temperature checking as designed by Silvia. Tests should fail (not skip)
...
class TestCRUDataLoading:
    ...
    def test_cru_data_file_exists(self):
        """Test that the CRU Parquet file exists and is accessible."""
        ...
        # Verify it's a valid Parquet file by attempting to load it
    ...
    def test_cru_temperature_lookup_major_cities(self):
        ...
        # These cities should have CRU data available
        test_cases = [
    ...
    def test_cru_seasonal_pattern(self):
        ...
        sydney_summer = get_mean_monthly_air_temperature(-33.9, 1, 151.2)  # Jan is summer
        sydney_winter = get_mean_monthly_air_temperature(-33.9, 7, 151.2)  # Jul is winter
