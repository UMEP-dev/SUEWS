...
class ValidationController(BaseModel):
    ...
    def _analyze_config(self) -> None:
        ...
        try:
            ...
            roughmethod_val = physics.get("roughness_momentum", physics.get("roughlenmommethod", 1))
            ...
            netrad_val = physics.get("net_radiation", physics.get("netradiationmethod", 0))
            ...
            emissions_val = physics.get("emissions", physics.get("emissionsmethod", 0))
            ...
            storage_val = physics.get("storage_heat", physics.get("storageheatmethod", 0))
